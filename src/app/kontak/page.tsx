        ...
        <Card className="border-navy-100">
          <CardContent className="p-6 space-y-4">
            <div className="flex items-start gap-3">
              <MapPin className="h-5 w-5 text-navy-600 mt-0.5 flex-shrink-0" />
              <div>
                <h3 className="font-semibold text-navy-900">Alamat Kantor</h3>
            ...
            <div className="flex items-center gap-3">
              <Phone className="h-5 w-5 text-navy-600 flex-shrink-0" />
              <div>
            ...
            <div className="flex items-center gap-3">
              <Mail className="h-5 w-5 text-navy-600 flex-shrink-0" />
              <div>
            ...
            <div className="flex items-center gap-3">
              <Globe className="h-5 w-5 text-navy-600 flex-shrink-0" />
              <div>
