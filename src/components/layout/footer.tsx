        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="text-sm text-blue-200 space-y-1">
              ...
              <a href="https://www.youtube.com/@lipanri8748" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 text-blue-300 hover:text-white transition-colors mt-2">
